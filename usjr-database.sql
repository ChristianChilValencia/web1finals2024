...
DROP TABLE IF EXISTS `usjr`.`users`;
...
(1, 'Christian', 'Valencia', 'W', 1001, 1, 2002),
(2, 'Aaron', 'Cornejo', 'B', 2002, 2, 2022),
(3, 'Mary', 'Mae', 'Rizaldo', 6001, 6, 2014),
(4, 'MJ', 'San', 'R', 2003, 2, 2004),
(5, 'James', 'Bond', 'J', 3002, 3, 2015),
(6, 'Chris', 'Val', 'V', 3004, 3, 2018),
(7, 'James', 'Monte', 'F', 1001, 1, 2007),
(8, 'Sheena', 'Marie', 'B', 4002, 4, 2006);

INSERT INTO `users` (`user_id`, `user_name`, `password`) VALUES
(678769, 'Christian', '123');
(678770, 'Valencia', '321');