    ...
    <div class="main-content expanded" id="main-content">
        <div class="header">
            <div class="add-button">
                <button class="btn-yellow" onclick="window.location.href='create_departments.php'"><img src="assets/add-icon.png" alt="Add">Create New Department</button>
            </div>
            <div class="user-info">
