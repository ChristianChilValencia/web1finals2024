...
<body>
    <div class="main-content expanded" id="main-content">
        ...
        <div class="add-button">
                <button class="btn-yellow" onclick="window.location.href='create_programs.php'"><img src="assets/add-icon.png" alt="Add">Create New Program</button>
            </div>
            <div class="user-info">
